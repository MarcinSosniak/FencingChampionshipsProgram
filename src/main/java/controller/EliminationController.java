...
public class EliminationController implements Initializable {
    ...
    private GridPane prepareTableViewPane(WeaponType wt) {
        ...
        TableColumn<Participant, String> name = new TableColumn<Participant, String>("imiê");
...
//                return x.getValue().getPointsForWeaponPropertyLastRound(wt);
    ...
    private GridPane prepareButtonPane(WeaponType wt) {
        ...
        nextRoundButton.setText("nastêpna runda");
        nextRoundButton.setOnAction(x -> {
            ...
            else
            {
                ...
                Stage stageroni = ApplicationController.getApplicationController().renderNextRound("/nextRound.fxml", "Nastêpna runda", true, wc,p);
        ...
        addPoints.setOnAction(x -> {
            ...
            if(AppMode.getMode().fSafe())
            {
                Alert alert = new Alert(Alert.AlertType.WARNING,"Nie masz uprawnieñ do wykonania tej akcji, przejdŸ do trybu administratora");
                alert.show();
                return;
            }
...
//        });
    ...
    private Tab initResultTab() {
     ...
     //   gridPane.set();
        ...
        /** Preparing title */
        Label text = new Label("WYNIKI KOÑCOWE");
        text.setTextAlignment(TextAlignment.CENTER);
        text.setStyle("-fx-alignment: CENTER;");
        ...
        tabToRet.setClosable(false);
        tabToRet.setText("wyniki koñcowe");
